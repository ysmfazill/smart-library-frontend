...
const INTEREST_META: Record<string, InterestMeta> = {
  ...
  'C': { icon: 'terminal', desc: 'Low-level systems programming, memory management, and compilers.' },
...
const FALLBACK_INTERESTS: Interest[] = [
  ...
  { id: 8, name: 'C', icon: 'terminal', desc: 'Low-level systems programming, memory management, and compilers.' },
