    ...
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2 pointer-events-none" role="region" aria-label="Notifications">
      {toasts.map(toast => (
        <div
          ...
          role="alert"
          aria-live="polite"
          className={`px-4 py-3 rounded-xl shadow-xl max-w-sm pointer-events-auto transform transition-all duration-300 translate-y-0 opacity-100 ${
        ...
        >
          <div className="flex justify-between items-start gap-3">
            ...
            <button
              ...
              className="text-white/70 hover:text-white p-1 min-h-[32px] min-w-[32px] flex items-center justify-center cursor-pointer"
